...
# Point to the SUMO config file inside 'data/sumo'
# This creates a path like: C:/.../FYP/data/sumo/parking.sumocfg
sumo_config_path = os.path.join(project_root, "data", "sumo", "parking.sumocfg")

# Verify it exists before running
if not os.path.exists(sumo_config_path):
    print(f"ERROR: Cannot find SUMO config at {sumo_config_path}")
    sys.exit(1)
